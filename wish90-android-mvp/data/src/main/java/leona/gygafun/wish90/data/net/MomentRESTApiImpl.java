...
public class MomentRESTApiImpl implements MomentApi {

  private final Context context;
  private final UserEntityJsonMapper userEntityJsonMapper;


  public MomentRESTApiImpl(Context context, UserEntityJsonMapper userEntityJsonMapper) {
  ...
  private String getUserEntitiesFromApi() throws MalformedURLException, JSONException,ParseException {
    return new leona.gygafun.wish90.data.net.ApiConnection(context).requestSyncCall();
  }
